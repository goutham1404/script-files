...
sed -i '58  a\<user username="tomcat" password="gout123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.113/conf/tomcat-users.xml
...
sudo sh apache-tomcat-9.0.113/bin/startup.sh
